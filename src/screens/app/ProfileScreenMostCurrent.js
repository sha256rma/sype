...
export default class ProfileScreen extends React.Component {
    ...
    state = {
      visible: true,
      username: 'bujarsefa',
      profile_image_src: 'https://www.familyandmedia.eu/wp-content/uploads/2018/10/529382-4386816-selfie-psicologia-725x545.jpg',
      followers: '100',
      following: '2',
      posts: '10',
      postList: [
...
},
{
  ...
  },
  {
    ...
    renderGrid = (element) => {
      return (
        ...
        <TouchableWithoutFeedback style={{ width:  '33%', margin: '.166%' }} onPress = {() => {console.log(element.item.post_id)}}>
          <Image source={{ uri: element.item.image_src }} style={{ width: '100%', aspectRatio: 1}} />
    ...
    renderList = (element) => {
      const { image_src, caption, username, userName, comments, likes, likers, bookmarkers } = element.item;
      ...
      return (
          <Card style={{ height: 500, width: '100%' }} >
              ...
              <Card.Cover source={{ uri: image_src }} style={{ height: '50%', width: '100%' }} />
              <Card.Content>
      ...
      return (
        <View style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <View style={{flexDirection: 'row', paddingVertical: 5, paddingHorizontal: 5}}>
              ...
              <View style={{}}>
                <Avatar.Image size={75} source = {{uri: this.state.profile_image_src}}/>
              </View>
              ...
              <View style={{flex: 1}}>
                ...
                <View style={{flexDirection: 'row',
                                justifyContent: 'center',
                                alignItems: 'center'}}>
                      <Chip style={{backgroundColor: 'white'}} icon="" onPress={() => console.log('Pressed Followers')}>Followers {this.state.followers}</Chip>
                      <Chip style={{backgroundColor: 'white'}} icon="" onPress={() => console.log('Pressed Following')}>Following {this.state.following}</Chip>
                      <Chip style={{backgroundColor: 'white'}}>Posts {this.state.posts}</Chip>
                  </View>
                  <View style={{flexDirection: 'row',
                                justifyContent: 'center',
                                alignItems: 'center'}}>
            ...
            <FlatList
                ...
                renderItem = {this.state.profile_view == 'grid' ? element => this.renderGrid(element)  : element => this.renderList(element) }
